...
public class ProfileInfoFormInitializer extends FormViewsInitializer {

    public ProfileInfoFormInitializer(Context context, int appTheme, int skin, int dialogSkin) {
